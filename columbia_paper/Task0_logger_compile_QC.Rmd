...
hobo <- logger_compile("2016", type = "hobo") %>%
  ...
  bind_rows(logger_compile("2022", type = "hobo")) %>%
  bind_rows(logger_compile("2023", type = "hobo")) %>%
...
hydro <- logger_compile("2016", type = "hydro") %>%
  ...
  bind_rows(logger_compile("2022", type = "hydro")) %>%
  bind_rows(logger_compile("2023", type = "hydro")) %>%
...
pldeur <- logger_compile("2016", type = "pldeur") %>%
  ...
  bind_rows(logger_compile("2022", type = "pldeur")) %>%
  bind_rows(logger_compile("2023", type = "pldeur")) %>%
