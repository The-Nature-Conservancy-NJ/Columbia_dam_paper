...
temp_do_col$site <- ifelse(temp_do_col$site %in% c("TNC_23"), "TNC_23 (Upstream)",
                    ifelse(temp_do_col$site %in% c("TNC_81"), "TNC_81 (Up Impoundment)",
                    ifelse(temp_do_col$site %in% c("TNC_80"), "TNC_80 (Low Impoundment)", 
                    ifelse(temp_do_col$site %in% c("TNC_25"), "TNC_25 (Downstream)", "NA"))))

temp_do_col$site <- factor(temp_do_col$site, 
                        levels = c("TNC_23 (Upstream)", "TNC_81 (Up Impoundment)", "TNC_80 (Low Impoundment)", "TNC_25 (Downstream)"))
...
columbia_macro_data$tnc_code <- ifelse(columbia_macro_data$tnc_code %in% c("TNC_23"), "TNC_23 (Upstream)",
                    ifelse(columbia_macro_data$tnc_code %in% c("TNC_80"), "TNC_80 (Low Impoundment)",
                    ifelse(columbia_macro_data$tnc_code %in% c("TNC_25"), "TNC_25 (Downstream)", "NA")))

columbia_macro_data$tnc_code <- factor(columbia_macro_data$tnc_code, levels = c("TNC_23 (Upstream)", "TNC_80 (Low Impoundment)", "TNC_25 (Downstream)"))
...
plot_mac <- columbia_macro_data %>%
  ...
  scale_linetype_manual(values = c("TNC_23 (Upstream)" = "solid", "TNC_80 (Low Impoundment)" = "dashed", "TNC_25 (Downstream)" = "longdash"), guide = "none")+
  coord_cartesian(clip = "off")
...
#order by upstream-downstream order
columbia_hab_data$tnc_code <- ifelse(columbia_hab_data$tnc_code %in% c("TNC_23"), "TNC_23 (Upstream)",
                    ifelse(columbia_hab_data$tnc_code %in% c("TNC_80"), "TNC_80 (Low Impoundment)",
                    ifelse(columbia_hab_data$tnc_code %in% c("TNC_25"), "TNC_25 (Downstream)", "NA")))

columbia_hab_data$tnc_code <- factor(columbia_hab_data$tnc_code, levels = c("TNC_23 (Upstream)", "TNC_80 (Low Impoundment)", "TNC_25 (Downstream)"))
...
eel_CPUE$Site <- ifelse(eel_CPUE$Site %in% c("TNC_23"), "TNC_23 (Upstream)",
                    ifelse(eel_CPUE$Site %in% c("TNC_16"), "TNC_16 (Upstream)",
                    ifelse(eel_CPUE$Site %in% c("TNC_19"), "TNC_19 (Upstream)",
                    ifelse(eel_CPUE$Site %in% c("TNC_25"), "TNC_25 (Downstream)", "NA"))))

eel_CPUE$Site <- factor(eel_CPUE$Site, levels = c("TNC_19 (Upstream)", "TNC_16 (Upstream)", "TNC_23 (Upstream)", "TNC_25 (Downstream)"))
...
ggplot(eel_CPUE, aes(x = Year, y = Mean, color = Site))+
  geom_rect(data = stage_bounds, aes(xmin = xmin, xmax = xmax, ymin = -Inf, ymax = Inf), show.legend = FALSE, inherit.aes = FALSE, alpha = 0.3)+
  ...
  labs(
    x = "Year", 
    y = "Mean # of eels per 50 m of shoreline"
  )+
  theme_classic()+
  scale_x_continuous(
    breaks = seq(min(eel_CPUE$Year, na.rm = TRUE), max(eel_CPUE$Year, na.rm = TRUE), by = 1))+
  scale_color_manual(values = c('TNC_25 (Downstream)' = "#53AaD4", 'TNC_23 (Upstream)' = 'orange', 'TNC_16 (Upstream)' = 'grey60', 'TNC_19 (Upstream)' = '#E0D42F'))
...
eel_length_freq$Site <- ifelse(eel_length_freq$Site %in% c("TNC_23"), "TNC_23 (Upstream)",
                    ifelse(eel_length_freq$Site %in% c("TNC_16"), "TNC_16 (Upstream)",
                    ifelse(eel_length_freq$Site %in% c("TNC_19"), "TNC_19 (Upstream)",
                    ifelse(eel_length_freq$Site %in% c("TNC_25"), "TNC_25 (Downstream)", "NA"))))


#2015
eel_length_freq_2015 <- eel_length_freq %>% filter(Year %in% c("2015"))

eel_length_freq_2015$Site <- factor(eel_length_freq_2015$Site, levels = c("TNC_19 (Upstream)", "TNC_16 (Upstream)", "TNC_23 (Upstream)", 'TNC_25 (Downstream)'))
...
eel_2015 <- ggplot(eel_length_freq_2015, aes(x = Rounded, y = Prop, fill = Site)) +
  ...
  labs(x = "Total length (cm)",
       y = "Frequency (%)") +
  theme_classic()+
  scale_fill_manual(values = c('TNC_25 (Downstream)' = "#53AaD4", 'TNC_23 (Upstream)' = 'orange', 'TNC_16 (Upstream)' = 'grey60', 'TNC_19 (Upstream)' = '#E0D42F'))+
  annotate(
    "text",
    x = 70, y = 15,                 
    label = paste0("2015  \n(n = 96)"),
...
eel_length_freq_2016$Site <- factor(eel_length_freq_2016$Site, levels = c("TNC_19 (Upstream)", "TNC_16 (Upstream)", "TNC_23 (Upstream)", 'TNC_25 (Downstream)'))
...
eel_length_freq_2017$Site <- factor(eel_length_freq_2017$Site, levels = c("TNC_19 (Upstream)", "TNC_16 (Upstream)", "TNC_23 (Upstream)", 'TNC_25 (Downstream)'))
...
eel_length_freq_2018$Site <- factor(eel_length_freq_2018$Site, levels = c("TNC_19 (Upstream)", "TNC_16 (Upstream)", "TNC_23 (Upstream)", 'TNC_25 (Downstream)'))
...
eel_length_freq_2019$Site <- factor(eel_length_freq_2019$Site, levels = c("TNC_19 (Upstream)", "TNC_16 (Upstream)", "TNC_23 (Upstream)", 'TNC_25 (Downstream)'))
...
eel_length_freq_2020$Site <- factor(eel_length_freq_2020$Site, levels = c("TNC_19 (Upstream)", "TNC_16 (Upstream)", "TNC_23 (Upstream)", 'TNC_25 (Downstream)'))
...
eel_length_freq_2022$Site <- factor(eel_length_freq_2022$Site, levels = c("TNC_19 (Upstream)", "TNC_16 (Upstream)", "TNC_23 (Upstream)", 'TNC_25 (Downstream)'))
...
eel_length_freq_2023$Site <- factor(eel_length_freq_2023$Site, levels = c("TNC_19 (Upstream)", "TNC_16 (Upstream)", "TNC_23 (Upstream)", 'TNC_25 (Downstream)'))
